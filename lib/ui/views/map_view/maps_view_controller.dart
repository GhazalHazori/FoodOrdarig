...
// class MapsController extends BaseControoler {
//   MapsController(LocationData location) {
//     currentLocation = location;
//   }
//   LocationData currentLocation;
//   Rx<LatLng> selecteLocation;
//   Rx<CameraPosition>_currentPosition ;
//   @override
//   void onInit() {
...
//   void init(LocationData currentLocation) {
...
//         position: LatLng(currentLocation.latitude ?? 37.42796133580664,
//             currentLocation.longitude ?? -122.085749655962)));
//   }

//   void addMarker(LatLng latlong) {
//     selectedLocation!.value = latlong;
//     markers.add(Marker(
//         markerId: MarkerId('current'),
...
import 'package:google_maps_flutter/google_maps_flutter.dart';
import 'package:location/location.dart';
import 'package:resturant/core/data/models/apis/country_model.dart';
import 'package:resturant/core/services/base_controller.dart';
import 'package:resturant/core/utils/maps_utile.dart';
import 'package:resturant/ui/shared/utlis.dart';
...
class MapController extends BaseControoler {
  ...
  RxList<CountryModel> resultList = <CountryModel>[].obs;
  ...
  void onInit() {
    ...
    countryJson.forEach((element) {
      resultList.add(CountryModel.fromJson(element));
      markers.add(Marker(
          markerId: MarkerId(CountryModel.fromJson(element).country!),
          position: LatLng(CountryModel.fromJson(element).latitude!,
              CountryModel.fromJson(element).longitude!.toDouble())));
    });
    super.onInit();
  }
  ...
  void getStreetName() async {
    await locationService
        .getLocationInfo(LocationData.fromMap({
